...
6. Per i valori di tutte le province su un indicatore che ha anche le regioni aprire la sua vista provinciale, cioè la scheda seguita da `/province` (per esempio `/indicatore/speranza-di-vita-alla-nascita/bes-01SAL001/province`), anche in Markdown: il canonico di una scheda con tutti e due i livelli si apre sulle regioni. Le schede solo provinciali si aprono già sulle province.
