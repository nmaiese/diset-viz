...
class OnlyProseCountsAsProse(unittest.TestCase):
    ...
    def test_the_list_is_the_producer_role_and_nothing_else(self):
        ...
        commento che promette una guardia inesistente è il difetto che questa
    ...
    def test_every_stage_that_can_open_a_run_is_recognised(self):
        """`RUN_ID` è un'altra enumerazione, e un ruolo che le manca non viene
        ...
        al ruolo che portano dentro (`legacy-writer` -> `writer`). È senza
