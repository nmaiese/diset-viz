# L'Italia che invecchia: l'indice di vecchiaia per regione nel 2026

Data: 2026-06-30
Ultima modifica: 2026-06-30
Autore: Redazione Divario Italia
URL canonica: https://divarioitalia.it/blog/italia-che-invecchia-indice-vecchiaia-2026

All'inizio del 2026 in Italia ci sono 233 anziani ogni 100 giovani. In Sardegna quasi 300, in Trentino-Alto Adige 168. La mappa dell'invecchiamento per regione.

L'indice di vecchiaia conta quanti anziani ci sono ogni cento giovani: di preciso,
la popolazione di 65 anni e più ogni cento ragazzi sotto i 15. È il modo più
sintetico per misurare quanto una popolazione è spostata verso l'alto nell'età.
...
Qui non esiste un valore "migliore": un indice alto segnala una popolazione più
anziana, un indice basso una più giovane, e il significato dipende dal contesto.
Detto questo, la geografia dell'invecchiamento non segue il solito confine
Nord-Sud. In testa per popolazione più anziana ci sono Sardegna (299,7), Liguria
(290,2) e Molise (272,4). Più giovani, all'opposto, Trentino-Alto Adige (168,5),
Campania (168,8) e Sicilia (192,0).

| Regione | Indice di vecchiaia 2026 (anziani per 100 giovani) |
|---|---|
| Sardegna | 299,7 |
| Liguria | 290,2 |
| Molise | 272,4 |
...
medio di 234,4 e il Mezzogiorno di 230,8. Praticamente identici. Mentre sul reddito
o sui giovani NEET i due blocchi sono lontanissimi, sull'invecchiamento la linea
Nord-Sud quasi scompare. **L'Italia invecchia ovunque, in modo abbastanza uniforme:**
è un fenomeno nazionale, non una frattura territoriale.
...
conti pubblici locali. Non è di per sé un problema, ma è una traiettoria che
chiede di essere governata, e che parte da punti molto diversi tra una regione e
l'altra.

Puoi esplorare l'indice di vecchiaia e gli altri indicatori demografici, anno per
anno e regione per regione, nella [scheda dell'indicatore](/indicatore/indice-di-vecchiaia/ter-921):
ci sono anche l'[età media della popolazione](/indicatore/eta-media-della-popolazione/ter-920) e il
...
- [Apri la scheda indicatore](https://divarioitalia.it/indicatore/indice-di-vecchiaia/ter-921)
