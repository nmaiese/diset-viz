...
bin/py -m unittest discover -s tests -v          # tutta la suite (627 test, ~22s), prima di commit/push
bin/py -m unittest discover -s tests/unit -v      # solo veloci (213 test, <1s), durante lo sviluppo
bin/py -m unittest discover -s tests/integration -v  # solo la parte pesante (414 test, ~21s): Flask/HTTP e catena e2e
