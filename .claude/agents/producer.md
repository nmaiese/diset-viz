...
claim comparativi, il `vintage` e il `reviewed_vintage`. Tu chiudi a firma e
commit dietro il cancello: il merge e' gia' la pubblicazione, non c'e' un passo a
valle che tu debba attendere.
