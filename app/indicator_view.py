...
def _query_map(meta, level):
    ...
    questions = [
        ...
        {"intent": "andamento", "label": f"Come è cambiato dal {level['year_min']} al {level['year_max']}?", "target": "serie-storica"},
        {"intent": "metodologia", "label": "Come sono calcolati confronti e medie?", "target": "fonti-verifica"},
    ]
