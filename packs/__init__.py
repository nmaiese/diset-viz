"""Il pacchetto: tutto ciò che serve a scrivere un indicatore, calcolato.
...
- `build`   adatta il view model dell'app a quella matrice, e monta il
            pacchetto completo. È l'unico posto che conosce `app`.
- `render`  stampa il pacchetto per chi scrive.

Il motivo della separazione non è l'eleganza. Il brief di oggi
...
indicatore, ed è l'unico modo perché la struttura dell'articolo nasca dai
